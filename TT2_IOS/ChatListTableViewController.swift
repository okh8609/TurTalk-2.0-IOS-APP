...
class ChatListTableViewController: UITableViewController {
    ...
    var ChatList: Array<Dictionary<String, AnyObject>> = []
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        cell.textLabel?.text = (ChatList[indexPath.row]["name"] as! String)
        cell.detailTextLabel?.text = String(ChatList[indexPath.row]["count"] as! Int)
